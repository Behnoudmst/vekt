...
export type EmailTemplateWhereInput = {
  ...
  type?: Prisma.EnumEmailTypeFilter<"EmailTemplate"> | $Enums.EmailType
...
export type EmailTemplateScalarWhereWithAggregatesInput = {
  ...
  type?: Prisma.EnumEmailTypeWithAggregatesFilter<"EmailTemplate"> | $Enums.EmailType
...
export type EmailTemplateOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"type" | "subject" | "body" | "updatedAt", ExtArgs["result"]["emailTemplate"]>
...
export interface EmailTemplateDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const emailTemplateWithSubjectOnly = await prisma.emailTemplate.findMany({ select: { subject: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many EmailTemplates and only return the `subject`
   * const emailTemplateWithSubjectOnly = await prisma.emailTemplate.createManyAndReturn({
   *   select: { subject: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more EmailTemplates and only return the `subject`
   * const emailTemplateWithSubjectOnly = await prisma.emailTemplate.updateManyAndReturn({
   *   select: { subject: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface EmailTemplateFieldRefs {
  readonly type: Prisma.FieldRef<"EmailTemplate", 'EmailType'>
